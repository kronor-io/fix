...
--       , FieldValueSpec
--           { fieldValueEnum = "3" , fieldValueDescription = "T_PLUS2" }
--       , FieldValueSpec
--           { fieldValueEnum = "4" , fieldValueDescription = "T_PLUS3" }
--       , FieldValueSpec
--           { fieldValueEnum = "5" , fieldValueDescription = "T_PLUS4" }
--       , FieldValueSpec
...
--       , FieldValueSpec
--           { fieldValueEnum = "9" , fieldValueDescription = "T_PLUS5" }
--       ]
--   }
data SettlType
  = SettlTypeRegular
