...
--       , FieldValueSpec
--           { fieldValueEnum = "2"
--           , fieldValueDescription = "ACKNOWLEDGE_EACH_QUOTE_MESSAGES"
--           }
--       ]
--   }
data QuoteResponseLevel
  ...
  | QuoteResponseLevelAcknowledgeEachQuoteMessages
