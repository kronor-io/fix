...
data PartiesGroupElem = PartiesGroupElem
  { partiesGroupElemPartyID :: !PartyID,
    ...
    partiesGroupElemPartyRoleQualifier :: !(Maybe PartyRoleQualifier),
    partiesGroupElemPartySubIDsGroup :: ![PartySubIDsGroupElem]
  }
...
instance IsComponent PartiesGroupElem where
  toComponentFields ((PartiesGroupElem {..})) =
    mconcat
      [ requiredFieldB partiesGroupElemPartyID,
        ...
        optionalFieldB partiesGroupElemPartyRoleQualifier,
        optionalGroupB partiesGroupElemPartySubIDsGroup
      ]
  fromComponentFields = do
    ...
    partiesGroupElemPartyRoleQualifier <- optionalFieldP
    partiesGroupElemPartySubIDsGroup <- optionalGroupP
...
makePartiesGroupElem partiesGroupElemPartyID =
  let partiesGroupElemPartyIDSource = Nothing
      ...
      partiesGroupElemPartyRoleQualifier = Nothing
      partiesGroupElemPartySubIDsGroup = []
   in (PartiesGroupElem {..})
