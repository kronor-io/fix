...
makeUnderlyingStipsGroupElem :: UnderlyingStipType -> UnderlyingStipsGroupElem
makeUnderlyingStipsGroupElem underlyingStipsGroupElemUnderlyingStipType =
  let underlyingStipsGroupElemUnderlyingStipValue = Nothing
   in (UnderlyingStipsGroupElem {..})
