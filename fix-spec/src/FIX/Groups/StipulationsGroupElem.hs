...
makeStipulationsGroupElem :: StipulationType -> StipulationsGroupElem
makeStipulationsGroupElem stipulationsGroupElemStipulationType =
  let stipulationsGroupElemStipulationValue = Nothing
   in (StipulationsGroupElem {..})
